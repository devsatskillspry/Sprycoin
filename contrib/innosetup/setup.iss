...
#define MyAppName "Sprycoin"
#define MyAppPublisher "2022 Sprycoin developers"
#define MyAppURL "https://sprycoin.io/"
#define MyAppExeName "sprycoin-qt.exe"
//#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/SPRY/bootstrap.zip"
...
DefaultDirName={autopf}\Sprycoin
...
OutputDir=.\output
OutputBaseFilename=SprycoinSetup
...
DefaultGroupName=Sprycoin Core
...
[Files]
Source: ".\package\sprycoin-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Sprycoin\Sprycoin-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Sprycoin\Sprycoin-Qt,strDataDir|{userappdata}\Sprycoin\}');
  Result := True;
end;

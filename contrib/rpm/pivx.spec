...
#man pages
Source20:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/sprycoind.1
Source21:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/sprycoin-cli.1
Source22:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/sprycoin-qt.1
...
%if %{_buildqt}
# qt icons
install -D -p share/pixmaps/sprycoin.ico %{buildroot}%{_datadir}/pixmaps/sprycoin.ico
install -p share/pixmaps/nsis-header.bmp %{buildroot}%{_datadir}/pixmaps/
install -p share/pixmaps/nsis-wizard.bmp %{buildroot}%{_datadir}/pixmaps/
install -p %{SOURCE100} %{buildroot}%{_datadir}/pixmaps/pivx.svg
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/sprycoin16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/sprycoin32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/sprycoin64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/sprycoin128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/sprycoin256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/sprycoin256.png %{buildroot}%{_datadir}/pixmaps/sprycoin16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/sprycoin256.png %{buildroot}%{_datadir}/pixmaps/sprycoin32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/sprycoin256.png %{buildroot}%{_datadir}/pixmaps/sprycoin64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/sprycoin256.png %{buildroot}%{_datadir}/pixmaps/sprycoin128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/sprycoin256.png %{buildroot}%{_datadir}/pixmaps/sprycoin256.xpm

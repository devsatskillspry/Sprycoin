...
# Create zip file of binaries
	cp Sprycoin/src/sprycoind DSW/src/sprycoin-cli Sprycoin/src/sprycoin-tx Sprycoin/src/qt/sprycoin-qt .
	zip Sprycoin-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip sprycoind sprycoin-cli sprycoin-tx sprycoin-qt
	rm -f sprycoind sprycoin-cli sprycoin-tx sprycoin-qt

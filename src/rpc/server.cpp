...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SPRY features */
        {"sprycoin", "listmasternodes", &listmasternodes, true },
        {"sprycoin", "getmasternodecount", &getmasternodecount, true },
        {"sprycoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"sprycoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"sprycoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"sprycoin", "masternodecurrent", &masternodecurrent, true },
        {"sprycoin", "startmasternode", &startmasternode, true },
        {"sprycoin", "createmasternodekey", &createmasternodekey, true },
        {"sprycoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"sprycoin", "listmasternodeconf", &listmasternodeconf, true },
        {"sprycoin", "getmasternodestatus", &getmasternodestatus, true },
        {"sprycoin", "getmasternodewinners", &getmasternodewinners, true },
        {"sprycoin", "getmasternodescores", &getmasternodescores, true },
        {"sprycoin", "preparebudget", &preparebudget, true },
        {"sprycoin", "submitbudget", &submitbudget, true },
        {"sprycoin", "mnbudgetvote", &mnbudgetvote, true },
        {"sprycoin", "getbudgetvotes", &getbudgetvotes, true },
        {"sprycoin", "getnextsuperblock", &getnextsuperblock, true },
        {"sprycoin", "getbudgetprojection", &getbudgetprojection, true },
        {"sprycoin", "getbudgetinfo", &getbudgetinfo, true },
        {"sprycoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"sprycoin", "mnfinalbudget", &mnfinalbudget, true },
        {"sprycoin", "checkbudgets", &checkbudgets, true },
        {"sprycoin", "mnsync", &mnsync, true },
        {"sprycoin", "spork", &spork, true },
...
{
    return "> sprycoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:37022/\n";
}

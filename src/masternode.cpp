...
{
  if (nHeight >  880000) return    55000 * COIN;
  if (nHeight >  825000) return    50000 * COIN;
  if (nHeight >  715000) return    45000 * COIN;
  if (nHeight >  660000) return    42000 * COIN;
  if (nHeight >  605000) return    39000 * COIN;
  if (nHeight >  550000) return    36000 * COIN;
  if (nHeight >  495000) return    33000 * COIN;
  if (nHeight >  440000) return    30000 * COIN;
  if (nHeight >  385000) return    27000 * COIN;
  if (nHeight >  330000) return    24000 * COIN;
  if (nHeight >  275000) return    21000 * COIN;
  if (nHeight >  220000) return    18000 * COIN;
  if (nHeight >  165000) return    15000 * COIN;
  if (nHeight >  110000) return    12000 * COIN;
  if (nHeight >   55000) return     8000 * COIN;
...
CAmount CMasternode::GetBlockValue(int nHeight)
{
    ...
    else if (nHeight <= 495000) {
        nSubsidy = 45 * COIN;
    }
    else if (nHeight <= 550000) {
        nSubsidy = 50 * COIN;
    }
    else if (nHeight <= 605000) {
        nSubsidy = 55 * COIN;
    }
    ...
    else if (nHeight <= 825000) {
        nSubsidy = 70 * COIN;
    }
    else if (nHeight <= 880000) {
        nSubsidy = 80 * COIN;
    }
    else if (nHeight <= 935000) {
        nSubsidy = 90 * COIN;
    }

    else if (nHeight >= 990000) {
        nSubsidy = 100 * COIN;
    }
...
{
     if (nHeight >   200) return GetBlockValue(nHeight) * 90 / 100;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 SPRY tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = UINT256_ZERO;
    CTransaction tx2;
    GetTransaction(vin.prevout.hash, tx2, hashBlock, true);
    BlockMap::iterator mi = mapBlockIndex.find(hashBlock);
    if (mi != mapBlockIndex.end() && (*mi).second) {
        CBlockIndex* pMNIndex = (*mi).second;                                                        // block for 1000 SPRY tx -> 1 confirmation

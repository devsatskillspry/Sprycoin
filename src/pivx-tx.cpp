...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Sprycoin sprycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sprycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sprycoin transaction") + "\n" +
                               "  sprycoin-tx [options] -create [commands]   " + _("Create hex-encoded sprycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sprycoin transaction

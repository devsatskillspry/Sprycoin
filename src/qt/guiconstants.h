...
/* Sprycoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Sprycoin"
#define QAPP_ORG_DOMAIN "sprycoin.org"
#define QAPP_APP_NAME_DEFAULT "Sprycoin-Qt"
#define QAPP_APP_NAME_TESTNET "Sprycoin-Qt-testnet"

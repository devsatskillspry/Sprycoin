...
/** Utility functions used by the Sprycoin Qt UI.
 */
namespace GUIUtil
{
...
// Render SPRY addresses in monospace font
...
// Parse "sprycoin:" URI into recipient object, return true on successful parsing

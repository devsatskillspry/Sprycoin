...
#define __PORT_MAINNET__ 37021
#define __PORT_TESTNET__ 18668
#define __PORT_REGTEST__ 28668
 ...
 * Sprycoin system. There are three: the main network on which people trade goods

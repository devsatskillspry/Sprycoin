...
# Create zip file of binaries
	cp Sprycoin/src/sprycoind.exe Sprycoin/src/sprycoin-cli.exe Sprycoin/src/sprycoin-tx.exe Sprycoin/src/qt/sprycoin-qt.exe .
	zip Sprycoin-Windows.zip sprycoind.exe sprycoin-cli.exe sprycoin-tx.exe sprycoin-qt.exe
	rm -f sprycoind.exe sprycoin-cli.exe sprycoin-tx.exe sprycoin-qt.exe

Contributing to Sprycoin Core
============================

The Sprycoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/SprycoinBF/Sprycoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Sprycoin Core project, and is not to be
confused with overall Sprycoin Network Protocol consensus changes.

Whether a pull request is merged into Sprycoin Core rests with the project merge
...
Patches that change Sprycoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Sprycoin consensus, it must have been
...
The project leader is the release manager for each Sprycoin Core release.

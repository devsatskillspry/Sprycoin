...
"""Verify that starting sprycoin with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sprycoin with -? for help text")
        ...
        self.log.info("Start sprycoin with -version for version information")
